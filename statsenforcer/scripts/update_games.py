...
def reset_games():
    game_list = pbpmodels.Game.objects.filter(endDateTime=None, dateTime__lte=datetime.datetime.today(), season=20162017, gamePk__gte=2016020000).values_list('gamePk', flat=True)
    players = get_players()
